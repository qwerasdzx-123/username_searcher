...
**跨平台用户名深度检索系统 — 一键检测用户名在 100+ 个主流社交平台上的注册状态，精准定位目标数字足迹。**
...
### 🔍 **智能检索引擎**
- **100+ 主流平台覆盖** — 涵盖全球热门社交、专业社区、小众论坛等多层级网站（基于 `data/社交网站及用户页面.json`）
...
│   └── 社交网站及用户页面.json # 网站列表与 URL 模板（104 个站点）
│
├── 📁 docs/                   # 文档资料
│   ├── README.md              # 英文说明文档
...
预期优化效果：
- **首次搜索**：通过优化代理和超时策略，预计提速 50-70%
- **重复搜索**：实现缓存后，预计提速 85-90%
